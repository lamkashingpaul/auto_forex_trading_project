...
def index(request):
    ...
    if request.method == 'POST':
        if 'search' in request.POST:
            ...
            if not request.session['saved_history_form']:
                return Http404('Session expired. Do the search again.')
                ...
                if saved_history_form.is_valid():
                    ...
                    if query_results:
                        ...
                        return StreamingHttpResponse((writer.writerow(row) for row in rows),
